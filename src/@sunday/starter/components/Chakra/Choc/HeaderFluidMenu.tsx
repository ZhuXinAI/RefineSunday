      ...
      <chakra.header h="full" bg={bg} w="full" px={{ base: 2, sm: 4 }} py={4}>
        <Flex alignItems="center" justifyContent="space-between" mx="auto">
          <Link display="flex" alignItems="center" href="/">
            <Image src={logoUrl} maxH="50px" maxW={"100px"} />
          </Link>
                    ...
                    >
                      ...
                      >
                        {(menu.subItems || []).map((subItem) => (
                          <Section title={subItem.title} icon={null}>
                            {subItem.subtitle}
                          </Section>
                        ))}
                      </SimpleGrid>
...
export const ChakraHeaderFluidMenu: IGridItem = {
  type: "chakra_choc_header_fluid_menu",
  label: "Header Nav",
  propsFields: [],
  component: ChocHeader,
  icon: <ChakraIcon />,
  editType: "jsonschema",
  schema: {
    type: "object",
